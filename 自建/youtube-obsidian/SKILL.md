...
# YouTube → Obsidian v1.2（阅读版：封面 + 分节总结一次展开 + 中文优先；课程类加均分截图，播客类仅封面）
...
## 语言规范（2026-09-13 v1.2：中文优先，禁止电报体）

- **正文是给人读的完整中文**：每句话有主谓宾、有上下文，段落读下来像人话。**禁止把句子压成短语**（不准为省字把"他不再逐个看，让智能体先筛一遍"写成"不再逐看，智能体先筛"这类文言文电报体）。宁可长，不可干。
- **英文白名单——只有这四类可以留英文**：① 中文技术语境里本来就说英文的词（如 Agent、Loop、Terminal、PR、API、harness、prompt、token）；② 模型名与产品名（Opus 4.5、Fable、Claude Code、Rails……）；③ 人名、地名、组织名等专有名词；④ 图标级短引（每节至多一两句，且必须配中文翻译）。
- **普通词一律译成中文**：joy→喜悦/兴奋，taste→品味，vision→眼光/愿景，chisel→雕琢，malleable→可塑/好改，payoff→回报，grieve→告别/哀悼，coasting→摸鱼/滑行，bargain→划算，scary→吓人，compassion→体谅，finitude→有限，myopia→短视，依此类推。拿不准就翻成中文，翻错了也比留英文强。
